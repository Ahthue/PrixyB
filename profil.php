...
<div class="container input-co text-center">
  ...
  <form action="inscription.php" method = "post">
    ...
    <!-- Zone de texte pour le login, le mdp et la confimation de mdp --> 
      ...
      <div class="row input-group col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
        <div class="col-lg-6">
          <input type="submit" name="validerInscription" class="form-control okForm" value="Valider" style="margin-bottom:10px;">
        </div>
        <div class="col-lg-6">
          <input type="submit" name="validerInscription" class="form-control okForm" value="Annuler" style="margin-bottom:10px;">
        </div>
      </div>
  </form>
</div>
