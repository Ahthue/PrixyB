...
<div class="container-fluid text-center input-co">
  ...
  <form method="post">
    ...
    <div class="input-group col-lg-6 col-lg-offset-3 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 input-co">
        ...
        <input type="text" class="form-control" name="login" maxlength="25" placeholder="Renseignez votre identifiant de connexion" required="required">
    </div>

    <!-- zone de texte pour le mot de passe -->
    <div class="input-group col-lg-6 col-lg-offset-3 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 input-co">
      <span class="input-group-addon" id="basic-addon3">Mot de passe</span>
      <input type="password" class="form-control" name="mdp" maxlength="25" placeholder="Renseignez votre mot de passe" required="required">         
    </div>
